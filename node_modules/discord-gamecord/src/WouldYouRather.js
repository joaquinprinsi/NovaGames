...
module.exports = class WouldYouRather extends events {
  ...
  async WyrQuestionVote(id, option) {
    return await fetch(`https://api.gamecord.xyz/wyr/vote?id=${id}&option=${option}`).then(res => res.json()).catch(e => { return {} });
  }
  ...
  async gameOver(msg, result) {
    ...
    this.WyrQuestionVote(this.data.id, result);
